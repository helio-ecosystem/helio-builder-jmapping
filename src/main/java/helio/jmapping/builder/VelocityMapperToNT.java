...
class VelocityMapperToNT {
	...
	protected static String toVelocityTemplate(TranslationRules rulesSource, TranslationRules rulesTarget, LinkRule rule) {
		...
		String sourceSubject = VelocityMapperToNT.computeVelocityTemplate4Rule(rulesSource.getSubject(), subjectSourceReferences, null);
	...
	protected static String toVelocityTemplate(TranslationRules rules) {
		...
		String subject = VelocityMapperToNT.computeVelocityTemplate4Rule(rules.getSubject(), subjectReferences, null);
		...
		rules.getProperties().stream()
							 .map(VelocityMapperToNT::toVelocityTemplate)
